 ...
 * This stablecaoin has the properties:
...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant MIN_FACTOR = 1e18;
    ...
    // Events
    event CollateralDepostied(address indexed user, address indexed token, uint256 indexed amount);
    ...
    */
    function depositCollateral(
        ...
        emit CollateralDepostied(msg.sender, tokenCollateralAddress, amountCollateral);
    ...
    */
    ...
    function liquidate(address collateral, address user, uint256 debtToCover) external moreThanZero(debtToCover) nonReentrant {
        ...
        if (startingUserHealthFactor >= MIN_FACTOR) {
        ...
        _redeemCollateral(collateral, totalCollateralToRedeem, msg.sender, msg.sender);
    ...
    */
    ...
    function _revertIfHealthFactorIsBroken(address user) internal view {
        ...
        if ( userHealthFactor < MIN_FACTOR) {
